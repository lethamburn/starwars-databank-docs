...
```text /GET/
GET https://starwars-databank-server.onrender.com/api/v1/characters/640b2d19c916010a8aa5a88e
```
...
```text /GET/ /Plo%20Koon/
GET https://starwars-databank-server.onrender.com/api/v1/characters/name/Plo%20Koon
```
