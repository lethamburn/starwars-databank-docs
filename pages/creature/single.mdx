...
```text /GET/
GET https://starwars-databank-server.onrender.com/api/v1/creatures/640b2f06b6a2a8104f0a0d9d
```
...
```text /GET/ /Porg/
GET https://starwars-databank-server.onrender.com/api/v1/creatures/name/Porg
```
