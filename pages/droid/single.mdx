...
```text /GET/
GET https://starwars-databank-server.onrender.com/api/v1/droids/640b304f916c6ff54731edb2
```
...
GET https://starwars-databank-server.onrender.com/api/v1/droids/name/Pit%20Droid
```
