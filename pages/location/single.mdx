...
```text /GET/
GET https://starwars-databank-server.onrender.com/api/v1/locations/640b31523f2eff6f409a9edf
```
...
```text /GET/ /Mustafar/
GET https://starwars-databank-server.onrender.com/api/v1/locations/name/Mustafar
```
