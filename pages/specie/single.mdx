...
```text /GET/
GET https://starwars-databank-server.onrender.com/api/v1/species/640b44d4a1996bc1b0f1c2e8
```
...
```text /GET/ /Wookiee/
GET https://starwars-databank-server.onrender.com/api/v1/species/name/Wookiee
```
