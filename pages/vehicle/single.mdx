...
```text /GET/
GET https://starwars-databank-server.onrender.com/api/v1/vehicles/640b461338c013fc5603e9e3
```
...
GET https://starwars-databank-server.onrender.com/api/v1/vehicles/name/X-wing%20Starfighter
```
